...
INSERT INTO entities (entity_type, canonical_value, display_label, aliases, domain_hints) VALUES
  ...
  ('system', 'Photoshop',      'Adobe Photoshop',  '["PSD","PS","Adobe PS"]'::jsonb, '["creative_design"]'::jsonb),
  ('system', 'Illustrator',    'Adobe Illustrator','["AI","Ai","Adobe AI"]'::jsonb, '["creative_design"]'::jsonb),
  ('system', 'Excel',          'Microsoft Excel',  '["XLS","XLSX","spreadsheet"]'::jsonb, '["finance_pricing","it_systems"]'::jsonb),
  ('system', 'Google Drive',   'Google Drive',     '["GDrive","drive"]'::jsonb, '["it_systems"]'::jsonb),
