...
const DEFAULT_SETTINGS: Array<{
  ...
  { key: 'default_transcript_summary_route', value: 'deepseek/deepseek-v4-flash', description: 'Auxiliary model route for Teams transcript picker preview summaries.' },
  { key: 'model_pool_transcript_summary', value: ['deepseek/deepseek-v4-flash', 'qwen/qwen3.6-flash'], description: 'Ordered fallback chain for Teams transcript picker preview summaries.' },
  ...
  { key: 'business_model_merge_enabled', value: false, description: 'Fail-safe R1 flag. When false, no source map may create shadow business-model proposals.' },
  { key: 'business_model_apply_enabled', value: false, description: 'Fail-safe R1 flag. When false, reviewed proposals cannot mutate the durable business model.' },
  { key: 'business_model_serving_enabled', value: false, description: 'Fail-safe R1 flag. When false, employee answers cannot use the durable business model.' },
