...
const DEFAULT_SETTINGS: Array<{
  ...
  { key: 'default_workflow_read_route', value: 'anthropic/claude-sonnet-5', description: 'Macro-first source workflow read model route.' },
  { key: 'model_pool_workflow_read', value: ['anthropic/claude-sonnet-5', 'google/gemini-2.5-pro', 'openai/gpt-4.1'], description: 'Ordered fallback chain for source workflow read.' },
