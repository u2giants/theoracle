...
export const modelCapabilities = pgTable(
  'model_capabilities',
  {
    ...
    strictJsonSchema: boolean('strict_json_schema').default(false).notNull(),
    deepSchemaAccepted: boolean('deep_schema_accepted').default(false).notNull(),
    adapterParamsSafe: boolean('adapter_params_safe').default(true).notNull(),
