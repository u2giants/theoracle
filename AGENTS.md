...
| Change macro-first extraction / workflow maps / source outlines / cross-claim relationships | Schema/settings: `packages/db/src/schema.ts`, `packages/db/migrations/sql/{79_macro_understanding,80_macro_auto_followup_settings,81_macro_lens_fanout_settings,82_macro_validation_tuning_settings,86_macro_first_schema}.sql`; prompts: `packages/ai/src/prompts/{workflow-read,source-outline,macro-relationship,coverage-audit}.ts`; workflow reader: `apps/workers/src/lib/source-workflow-read.ts`, `apps/workers/src/trigger/source-workflow-read.ts`; legacy budget gate while still present: `apps/workers/src/lib/document-lens-budget.ts`; workers: `apps/workers/src/trigger/{document-ingestion,source-outline,document-lens-extraction,macro-relationship-extraction,source-coverage-audit}.ts`; admin: `apps/web/app/admin/{macro,business-model,recommendations}/**`; eval log: `evals/macro-first-battery.md`; consumption helpers: `packages/oracle-engines/src/macro/approved-relationships.ts`, chat, Brain synthesis. | quote validator/provenance rules unless explicitly changing evidence policy; generated Drizzle migrations |
