...
- root markdown files — `README.md`, `AGENTS.md`, `CLAUDE.md`, `DECISIONS.md`, `china_imp.md`, and the planning docs `fix_remove_fallbacks.md` / `fix_resolve_ts.md` / `fix_claim_extr.md` / `fix_TESTPLAN.md` (self-contained specs/session plans — load only when doing that specific work)
