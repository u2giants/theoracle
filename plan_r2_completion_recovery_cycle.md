...
| G9. Live prompt-contract check | OPEN - the prerequisite for any further prompt work | No gate anywhere proves a live model still returns one record per requested seed. Its absence is why the 13/30 regression reached production. |
