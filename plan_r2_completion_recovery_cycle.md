...
| G8. Restore the served map | BLOCKED ON OWNER | The active map for the document is the 13/30 one. The 23/30 map `224ca68d-...` is superseded but intact. Restoring it is a production data write and needs Albert to name it, or a fresh run. |
