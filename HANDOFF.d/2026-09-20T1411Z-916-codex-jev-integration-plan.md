...
2. Execute **M0A only**: inventory/order/tokenizer/task-gate/command-and-seed closure, with its own independent review/PR/merge and no database write. Successor sessions take M0B, M0C, M0D, then M0E; no session bundles milestones or adds Jev schema.
