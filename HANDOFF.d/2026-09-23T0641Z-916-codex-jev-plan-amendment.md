...
- M0F requires a distinct reviewer-signed production-write authorization bound to the exact merged SHA, target, ordered actions, digests, allowlist, expiry, and single-use run ID before credentials or writes.
