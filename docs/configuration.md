...
| `source_reader_max_repair_attempts_per_source` | `1` | Maximum bounded segmentation repair attempts for one source. Repairs consume the same call/token/cost budgets. |
