...
| Multi-turn messages                      | `providerOptions.messages` override (Vercel-AI-SDK-shaped `ChatCompletionMessageParam[]`).                                                                                                                         | Same.                                                                                                                                                                                                                         | Transforms text, image, and PDF parts into Vertex `contents`; the file-cache path preserves the full conversation and every non-cached attachment as live contents on top of the cached prefix.                                                                                                                                                                                                                                                                                                                                                                                                                                                  | Same as OpenAI.                                                                                                                                                                                                                                             | Same as OpenAI.                                                                                                                                                                                                                                                                    |
| What it CAN'T do today                   | Streaming-with-tools end-to-end in this codebase; tool_use streaming requires explicit demuxing not yet wired.                                                                                                     | Vision input wiring inside the adapter (chat route handles it outside the adapter via a regex — see AGENTS.md pending work).                                                                                                  | Cross-provider inline fallback is intentionally limited to a conservative attachment byte budget. Above that budget, only a Vertex file-cache request is allowed, and successful GCS/cache preparation is required before model dispatch. A failed required cache stops clearly; smaller requests safely continue inline after an optional cache failure.                                                                                                                                                                                                                                                                                         | Strict json_schema (deepseek doesn't expose it). Streaming.                                                                                                                                                                                                 | Strict json_schema. Streaming. The structured-output path still uses Chat Completions rather than Responses.                                                                                                                                                                       |
